...
public class TileManager : MonoBehaviour
{
    ...
    [SerializeField] private float m_tileSize = 220f;
    ...
    private void SetBoardSize()
    {
        ...
        {
            RT.sizeDelta = new Vector2(parentSize.x, parentSize.x);
    ...
    private void PositionStartTiles()
    {
        ...
        for (int i = 0; i < m_startTiles.Count; i++)
        {
            if (m_startTiles[i] != null)
            {
    ...
    private void PositionEndTiles()
    {
        ...
        for (int i = 0; i < m_endTiles.Count; i++)
        {
            if (m_endTiles[i] != null)
            {
